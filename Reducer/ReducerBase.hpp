...
private:
    ...
    std::vector<std::map<std::string, std::map<std::string, size_t>>> reducedOutput;
...
public:
    ...
    void setReducedOutput(const std::vector<std::map<std::string, std::map<std::string, size_t>>> &reduced_result){
        this->reducedOutput = reduced_result;
    }

    // Getters
    // This method retrieves the reducedOutput private data member
    std::vector<std::map<std::string, std::map<std::string, size_t>>> getReducedOutput(){
